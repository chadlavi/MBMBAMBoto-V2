...
r = praw.Reddit("My Brother, My Brother, and Me Episode Grabber v1.0 by /u/Quip_Qwop") # Create the reddit object
o = OAuth2Util.OAuth2Util(r,print_log=True) #OAuth verification stuff
o.refresh(force=True) #OAuth token refresh stuff; Always auto-refresh token when neccesary
while True:
	try:
		...
		full_comments = r.get_subreddit("mbmbam").get_comments() #get the comments generator
